...
def serve(config: str | None, preset: str | None):
    ...
    from puppet_ai.config.presets import get_preset
    from puppet_ai.config.schema import VisionPipeConfig
...
async def _run_mcp_server(cfg):
    ...
    TOOL_DESCRIPTIONS = {
        ...
        "system_unmask": "Temporarily disable PII masking. WARNING: takes effect immediately, no technical confirmation gate. Agent MUST ask user before calling.",
    ...
    def _sanitize_for_json(obj):
        """Remove control characters from strings that break JSON parsing."""
