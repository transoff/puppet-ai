# src/puppet_ai/providers/__init__.py
...
class ProviderRegistry:
    ...
    def discover_entry_points(self) -> None:
        try:
            eps = importlib.metadata.entry_points(group="puppet_ai.providers")
        except TypeError:
            eps = importlib.metadata.entry_points().get("puppet_ai.providers", [])
        for ep in eps:
